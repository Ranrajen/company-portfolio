      ...
      <div className="container-custom py-16">
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M4 4h4v16H4V4zm6 0h4v2.2c.7-1.2 2.2-2.4 4.3-2.4 3.4 0 5.7 2.2 5.7 6.5V20h-4v-8.4c0-2-.8-3.2-2.5-3.2-1.4 0-2.5 1-2.9 2v9.6h-4V4z"
                  />
                </svg>
              </a>
            </div>
            ...
            <ul className="space-y-3">
              {footerLinks.company.map((link) => (
                <li key={link.href}>
                  <Link
                    to={link.href}
                    className="text-white/45 text-sm hover:text-brand-crimson smooth-transition"
                  >
                    {link.name}
                  </Link>
                </li>
            ...
            <ul className="space-y-3 text-sm text-white/45">
              ...
              <li>
                <a
                  ...
                  className="hover:text-brand-crimson smooth-transition"
                >
        ...
        <div className="mt-14 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/30">
          ...
          <p className="text-white/40">
            Developed by{' '}
            <a
              href="https://www.linkedin.com/in/rajen-rangari"
              target="_blank"
              rel="noopener noreferrer"
              className="font-medium text-white hover:text-primary smooth-transition"
            >
              Rajen Rangari
            </a>
          </p>
